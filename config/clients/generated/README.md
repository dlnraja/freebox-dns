...
| Extra | Endpoint |
| --- | --- |
| **DoQ** (uncensored) | `quic://192.168.1.71:8853` |
| **DNSCrypt proxy** | `192.168.1.71:5359` (Do53→DNSCrypt→Quad9 nofilter) |
| **DNSCrypt server** | `192.168.1.71:8443` / `dnscrypt-stamp.txt` (after `scripts/dnscrypt-server-init.sh`) |
